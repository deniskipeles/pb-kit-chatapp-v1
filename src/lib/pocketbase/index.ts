...
import PocketBase, { LocalAuthStore, isTokenExpired, type RecordModel, type AuthModel } from 'pocketbase';
...
import { protectedFilesCollectionsCache } from '$lib/store/collections';
...
const currentUser:Writable<AuthModel|RecordModel> = writable(pb.authStore.model);
